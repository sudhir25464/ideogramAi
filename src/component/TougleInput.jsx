  ...
  return (
    <div className="main-input-container">
      <div className="container">
        ...
        {/* side icon -second container */}
        <div className="clear-text-btn">
          <button className="tougle-input-icon-btn" onClick={clearUserInput}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <div className="right-side-input-container">
          <div className="right-input-top-icon-section">
            <div className="right-top-icon">
              ...
              <button className="top-right-btn-2  tougle-input-icon-btn">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div className="right-top-icon">
              <button
                className="tougle-input-icon-btn"
          ...
          <div className="options-section">
            <div className="toggle-group">
              <div className="magic-promt-container">
          ...
          <div className="right-input-bottom-section">
            <button className="used-credits-input-btn1">Uses credits</button>
            {LoadingState ? (
              <button className="loading-input-btn1">loading..</button>
            ) : (
              <button className="generate-input-btn1" onClick={HandleSubmit}>
                Generate
              </button>
            )}
          </div>
